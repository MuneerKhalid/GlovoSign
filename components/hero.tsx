          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p
                ...
                data-aos-delay="150"
              >
                Welcome to GlovoSign – where silent expressions find a powerful
                voice. Step into a world of inclusive communication, as our
                gesture gloves and advanced technology redefine the language of
